                ...
                <form action="{{ route('surat-keluar.update', $suratKeluar->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="kategori_id" id="kategori_id" class="form-select @error('kategori_id') is-invalid @enderror" required>
                                        ...
                                        @foreach ($kategori as $item)
                                            <option value="{{ $item->id }}" {{ $suratKeluar->kategori_id == $item->id ? 'selected' : '' }}>
                                                {{ $item->nama_kategori }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('sifat_surat') is-invalid @enderror" id="sifat_surat" name="sifat_surat" required>
                                        <option value="">Pilih Sifat Surat</option>
                                        @foreach(['biasa', 'penting', 'segera', 'rahasia'] as $sifat)
                                            <option value="{{ $sifat }}" {{ $suratKeluar->sifat_surat == $sifat ? 'selected' : '' }}>{{ ucfirst($sifat) }}</option>
                                        @endforeach
                                    </select>
                                    @error('sifat_surat')
                                        <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="nomor_surat">Nomor Naskah <span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            <!-- Klasifikasi dan Dikirim Melalui -->
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('dikirimkan_melalui') is-invalid @enderror"
                                           id="dikirimkan_melalui" name="dikirimkan_melalui"
                                           value="{{ old('dikirimkan_melalui', $suratKeluar->dikirimkan_melalui) }}" required>
                        ...
                        <div class="row">
                            <!-- Hal dan Tujuan Surat -->
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="hal">Hal <span class="text-danger">*</span></label>
                                    <textarea class="form-control @error('hal') is-invalid @enderror" id="hal" name="hal" rows="3" required>{{ old('hal', $suratKeluar->hal) }}</textarea>
                                    @error('hal')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('tujuan_surat') is-invalid @enderror" id="tujuan_surat" name="tujuan_surat" rows="3" required>{{ old('tujuan_surat', $suratKeluar->tujuan_surat) }}</textarea>
                                    @error('tujuan_surat')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama_penandatangan') is-invalid @enderror"
                                   ...
                                   value="{{ old('nama_penandatangan', $suratKeluar->nama_penandatangan) }}" required>
                        ...
                        <!-- File Surat -->
                        <div class="form-group">
                            <label for="file_surat">File Surat (Biarkan kosong jika tidak ingin diubah)</label>
                            <div class="custom-file">
                                <input type="file" class="custom-file-input @error('file_surat') is-invalid @enderror"
                                       id="file_surat" name="file_surat" accept=".pdf,.doc,.docx">
                                <label class="custom-file-label" for="file_surat">Pilih file...</label>
                            </div>
                            @if ($suratKeluar->file_surat)
                                <small class="form-text text-success">
                                    File saat ini: <a href="{{ asset('storage/' . $suratKeluar->file_surat) }}" target="_blank">{{ basename($suratKeluar->file_surat) }}</a>
                                </small>
                            @endif
